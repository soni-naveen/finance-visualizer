          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Set intelligent budgets for different categories and track
                  your progress with real-time notifications and insights.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Effortlessly log transactions, categorize expenses, and
                  monitor your financial health with our intuitive interface.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Organize expenses with smart categorization and custom
                    labels
                  </p>
                </div>
              </div>
